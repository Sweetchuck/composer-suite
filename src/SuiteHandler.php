...
class SuiteHandler
{
    ...
    public function generate(array $composerData, array $actions): array
    {
        ...
        $this->generateAddComment($composerData);

        return $composerData;
    }

    public function generateAddComment(array &$composerData)
    {
        if (array_key_exists('_comment', $composerData)) {
            settype($composerData['_comment'], 'array');
        } else {
            $composerData = ['_comment' => []] + $composerData;
        }

        array_unshift(
            $composerData['_comment'],
            'DO NOT EDIT THIS FILE. Content of this file can be overwritten by the `suite:generate` command.',
        );
